...
public class DouBanConfig {
    ...
    public DouBanConfig() {
        this.url = "https://movie.douban.com/j/search_subjects";
     ...
     */
    private  String doGetHtml() throws URISyntaxException {
        //创建HTTPClient对象
    ...
    public LinkedList<String> startLoad(String type,String limit,String start) throws URISyntaxException {
        LinkedList<String> re = new LinkedList<>();
        this.map.put("type",type);
        this.map.put("page_limit",limit);
        this.map.put("page_start",start);
